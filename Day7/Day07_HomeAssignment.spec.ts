...
//add firstname input
await page.locator("//input[@name='firstname']").fill("Ravi")
//add lastname input
await page.locator("//input[@name='lastname']").fill('Rajen')
...
// enter gmail id
await page.locator("//input[@name='reg_email__']").fill("ravi123@gmail.com")
// enter new password
